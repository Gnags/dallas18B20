...
class DallasTemperature {
  ...
  DallasTemperature();
    DallasTemperature(OneWire *_ow);
     void hugo(OneWire *_ow);
    
  // initialise bus
  void begin(void);
  void begin(uint8_t *AddrArray, uint8_t offset);
  ...
  void  blockTillConversionComplete(uint8_t, const uint8_t*);
    ...
    uint8_t ds18B20Idx;
    bool waitAfterRequest;
    uint8_t sensorToUpdate[_maxSensorsPerBus];
